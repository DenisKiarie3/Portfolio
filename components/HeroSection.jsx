        ...
        <div className="container max-w-4xl mx-auto text-center z-10">
            <div className="space-y-6">
                ...
                <p 
                    ...
                    I craft modern, responsive, and visually stunning websites using React, 
                    Tailwind CSS, and JavaScript as a fullstack developer.Let's build fast, 
                    clean, and user-focused experiences together.
                </p>
