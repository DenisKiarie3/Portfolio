...
const skills = [
  ...
  { name: "Form Handling (React)", level: 80, category: "frontend" },
  ...
  { name: "Database Deployment (Railway)", level: 80, category: "backend" },
  { name: "MVC Architecture", level: 75, category: "backend" },

  // Tools
  { name: "Git/GitHub", level: 90, category: "tools" },
  { name: "VSCode", level: 95, category: "tools" },
  { name: "Postman/Thunder Client", level: 85, category: "tools" },
  { name: "Netlify/Render", level: 85, category: "tools" },
  { name: "Linux Terminal (Ubuntu)", level: 80, category: "tools" },
  { name: "Figma (for UI references)", level: 75, category: "tools" },
